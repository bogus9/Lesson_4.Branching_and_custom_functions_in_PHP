...
/* В секции ИТОГО должно быть указано: сколько всего наименовний было заказано, каково общее количество товара, какова общая сумма заказа
...
* то на эту позицию ему автоматически дается скидка 30% (соответственно цены в корзине пересчитываются тоже автоматически) */
    ...
    uvedomlenie($bear, $jacket, $bicycle);
...
//        $discount_sum=$discount+$discount_bear+$discount_jacket+$discount_bicycle;
     ...
     * после чего когда вставлял функцию в echo внутри функции uvedomlenie,  на выходе в данной секции глобальная 
     ...
     * 
     *  ??? Также пробовал просто указывать в функции uvedomlenie глобальную переменную и определять
    ...
    function uvedomlenie($bear, $jacket, $bicycle) {
